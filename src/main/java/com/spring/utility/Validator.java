...
public class Validator {
	...
	/*
	 * public static boolean isEmailAlreadyExist(String email) { Optional<User>
	 * user=userRepo.findByemail(email); if(user.isPresent()) { return true; } else
	 * { return false; } }
	 */
}
